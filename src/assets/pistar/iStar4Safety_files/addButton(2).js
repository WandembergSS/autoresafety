...
ui.components.createAddButtons = function() {
    ...
    $('#add-actor-dropdown, #add-actor-link-dropdown, #add-dependency-dropdown, #add-ContributionLink-dropdown, #add-ObstructLink-dropdown').empty();
    $('#add-internal-cells-palette').empty();
